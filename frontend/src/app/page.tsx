...
import {
  type ChromosomeFromSearch, type GeneFromSearch,
  type GenomeAssemblyFromSearch,
  getAvailableGenomes,
  getGenomeChromosomes, searchGenes
...
export default function HomePage() {
  ...
  const handleSearch = async (e?: React.FormEvent) => {
    ...
    await performGeneSearch(searchQuery, selectedGenome);
  }
  ...
  return (
    <div className='min-h-screen bg-[#e9eeea]'>
      ...
      <main className='container mx-auto px-6 py-6'>
        {selectedGene ? (
            <GeneViewer gene={selectedGene} genomeId={selectedGenome} onCloseAction={() => setSelectedGene(null)} />
        ) : (
            <>
              <Card className='mb-6 gap-0 border-none bg-white py-0 shadow-sm'>
                <CardHeader className='pt-4 pb-2'>
                  <div className='flex items-center justify-between'>
                    ...
                    <div className='text-sm font-normal text-[#3c4f3d]/60'>
                ...
                <CardContent className='pb-4'>
                  <div className='w-full min-w-0'>
                    <Select
                        ...
                        disabled={isLoading}
                    >
                      <SelectTrigger className='h-9 w-full min-w-0 border-[#3c4f3d]/10'>
                        ...
                        <div className='flex flex-wrap gap-2'>
                          {chromosomes.map((chrom) => (
                              <Button
                                  ...
                                  variant='outline'
                                  size='sm'
                                  className={`h-8 cursor-pointer border-[#3c4f3d]/10 hover:bg-[#e9eeea] hover:text-[#3c4f3d] ${selectedChromosome === chrom.name ? "text-[#3c3f3d] bg-[#e9eeea]" : ""}`}
                      ...
                      <div className='flex h-48 flex-col items-center justify-center text-center text-gray-400'>
                        ...
                        <p className='text-sm leading-relaxed'>
                          {mode === "search"
                              ...
                              : selectedChromosome
                                  ? "No genes found on this chromosome" : "Select a chromosome to view genes"
                          }
                        </p>
                      </div>
                  )}
