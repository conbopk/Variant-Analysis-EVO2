...
import {GeneSequence} from "~/components/gene-sequence";
import KnownVariants from "~/components/known-variants";
import {VariantComparisonModal} from "~/components/variant-comparison-modal";
import VariantAnalysis, {type VariantAnalysisHandle} from "~/components/variant-analysis";


export default function GeneViewer({gene, genomeId, onCloseAction}: {
  gene: GeneFromSearch,
  genomeId: string,
  onCloseAction: () => void;
}) {
  ...
  return (
      <div className='space-y-6'>
        ...
        <KnownVariants
          refreshVariantsAction={fetchClinvarVariants}
          showComparisonAction={showComparison}
          updateClinvarVariantAction={updateClinvarVariant}
          clinvarVariants={clinvarVariants}
        ...
        <GeneSequence
          ...
          onStartPositionChangeAction={setStartPosition}
          onEndPositionChangeAction={setEndPosition}
          sequenceData={geneSequence}
          sequenceRange={actualRange}
          isLoading={isLoadingSequence}
          error={error}
          onSequenceLoadRequestAction={handleLoadSequence}
          onSequenceClickAction={handleSequenceClick}
          maxViewRange={10000}
        />
