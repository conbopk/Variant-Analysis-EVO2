      ...
      return (
          <Card className='gap-0 border-none bg-white py-0 shadow-sm'>
            ...
            <CardContent className='pb-4'>
              ...
              {variantPosition && clinvarVariants.filter(
                  (variant) => variant.variation_type.toLowerCase().includes("single nucleotide")
                      ...
                      <div className='grid gap-4 grid-cols-2'>
                        <div>
                          ...
                          <div className='mt-2 text-xs text-[#3c4f3d]/70'>
                            ...
                            <span className={`mt-1 rounded-sm px-2 py-0.5 ${getClassificationColorClasses(matchedVariant.classification)}`}>
                        ...
                        <div className='flex items-center justify-end'>
                          <Button
                            ...
                            onClick={() => {
                              ...
                              void handleVariantSubmit(variantPosition.replaceAll(",", ""), alt);
                            }}
                          >
                            {isAnalyzing ? (
                                <>
                                  <span className='mr-1 inline-block h-3 w-3 animate-spin rounded-full border-2 border-[#3c4f3d] border-t-transparent align-middle' />
                                  Analyzing...
                                </>
                            ) : (
                                <>
                    ...
                    <div className='grid gap-4 md:grid-cols-2'>
                      <div>
                        <div className='mb-2'>
                          ...
                          <div className='text-sm mt-1'>
                            <span className='flex'>{gene.description}{" "}</span>
                            <span>{gene.symbol} {variantResult.position.toLocaleString()}{" "}</span>
                        ...
                        <div>
                          ...
                          <div className='text-sm'>
                            {variantResult.delta_score.toFixed(8)}
                          </div>
                      ...
                      <div>
                        ...
                        <div className='mt-3'>
                          ...
                          <div className='mt-1 text-right text-xs text-[#3c4f3d]/80'>
                            {(variantResult.classification_confidence * 100).toFixed(2)}%
                          </div>
                        </div>
                      </div>
                    </div>
